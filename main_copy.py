...
class PayStubs:
    ...
    def paystub_function(self, name , employee_address):
...
class Proof_Of_SIN:
    ...
    def making_sin_pdf_file(self, name_i, employee_address_i, sin_number_i):
        ...
        self.convert_to_pdf(f"Proof_Of_SIN.pdf")
        try:
    ...
    def P_SIN_Function(self, name, employee_address):
        print("*************************************")
        print("*************************************")
...
if __name__ == '__main__':
    ...
    if int(document_type) == 1:
        pay_sub_object = PayStubs()
        pay_sub_object.paystub_function(name, employee_address)
    elif int(document_type) == 2:
        sin_object = Proof_Of_SIN()
        sin_object.P_SIN_Function(name, employee_address)
